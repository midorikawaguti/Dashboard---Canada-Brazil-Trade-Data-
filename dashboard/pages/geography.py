...
def layout():
    return html.Div([
        ...
        html.Div(children=[
            ...
            html.P('Trade flows by province and country', style={
        ...
        html.Div([
            # html.Div(dcc.Graph(id='province-map'),    style=STYLE_CHART_ITEM),
            # html.Div(dcc.Graph(id='country-bar'),     style=STYLE_CHART_ITEM),
