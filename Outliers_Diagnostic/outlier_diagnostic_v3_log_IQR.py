"""
OUTLIER GROUPING DIAGNOSTIC v3 — outlier_grouping_diagnostic.xlsx
==================================================================
METHOD: Log-scale IQR (log-IQR)
  IQR is computed on log10(unit_price) so fences are multiplicative.
  This fixes the negative-lower-fence blind spot of raw IQR on
...
OUTPUT_FILE = OUTPUT_DIR / "outlier_grouping_diagnostic_log_IQR.xlsx"
